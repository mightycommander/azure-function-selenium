...
from ..urls import HQ_V1_URL, HQ_V2_URL, ISSUES_V1_URL
...
class HQ(ForgeBase):
    ...
    def get_issues(self, container_id):
        ...
        url = "{}/containers/{}/quality-issues?page[limit]=100&include=attachments&include=comments".format(
            ISSUES_V1_URL,
            container_id
        )
        logger.info("URL: " + url)
        ...
        data, _ = self.session.request(
            ...
            url,
            headers=headers,
            message="issues for project '{}'".format(container_id),
        )
